...
import { Search, Filter, Play, Globe, Star, Clock, Wifi } from 'lucide-react';
...
export default function Channels() {
  ...
  }, [channelsWithStreams, searchTerm, selectedCategory, selectedCountry]);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg mt-4">Loading channels...</p>
        </div>
      </div>
    );
  }
              ...
              >
                ...
                <div className="p-4">
                  <div className="flex items-start gap-3 mb-3">
                    <div className="text-2xl">{getCountryFlag(channel.country)}</div>
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-white truncate group-hover:text-purple-400 transition-colors">
                        {channel.name}
                      </h3>
                      <p className="text-sm text-gray-400">{getCountryName(channel.country)}</p>
                    </div>
                  </div>
